        ...
        detail = RunDetail.from_dict(
            {
                ...
                "provider_used": str(detail_payload.get("provider_used", "") or "").strip(),
                "provider_fallback": bool(detail_payload.get("provider_fallback", False)),
                "provider_reason": str(detail_payload.get("provider_reason", "") or "").strip(),
                "llm_provider": str(detail_payload.get("llm_provider", "") or "").strip(),
                "llm_model": str(detail_payload.get("llm_model", "") or "").strip(),
                "llm_runtime_available": bool(detail_payload.get("llm_runtime_available", False)),
                "llm_auth_present": bool(detail_payload.get("llm_auth_present", False)),
                "jira_auth_present": bool(detail_payload.get("jira_auth_present", False)),
                "llm_request_attempted": bool(detail_payload.get("llm_request_attempted", False)),
                "llm_request_succeeded": bool(detail_payload.get("llm_request_succeeded", False)),
                "llm_failure_reason": str(detail_payload.get("llm_failure_reason", "") or "").strip(),
                "provider_quota_exhausted": bool(detail_payload.get("provider_quota_exhausted", False)),
                "run_invalid_due_to_provider": bool(detail_payload.get("run_invalid_due_to_provider", False)),
