...
{
    public class ContractorDto : ContractorSimpleDto
    {
        [JsonProperty("abc_id")]
        ...
        [JsonProperty("invoice_bulk_add_product_columns")]
        public List<string> InvoiceBulkAddProductColumns { get; set; }

        [JsonProperty("currency_permissions")]
        public List<ContractorCurrencyPermissionDto> CurrencyPermissions { get; set; }

        [JsonProperty("parser_settings")]
        public List<ParserSettingsDto> ParserSettings { get; set; }

        [JsonProperty("is_individual")]
        public bool IsIndividual { get; set; }

        [JsonProperty("created_in_1c")]
        ...
        [JsonProperty("parse_features")]
        public bool ParseFeatures { get; set; }

        [JsonProperty("parse_features_priority")]
        public int? ParseFeaturesPriority { get; set; }
