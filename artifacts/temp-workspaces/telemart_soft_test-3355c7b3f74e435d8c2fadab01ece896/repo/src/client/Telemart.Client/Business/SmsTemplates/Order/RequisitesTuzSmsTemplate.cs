...
{
    public sealed class RequisitesTuzSmsTemplate : ISmsTemplate
    {
        public RequisitesTuzSmsTemplate(int orderId, Payment paymentType, decimal toPayUah, SmsTemplate template)
        {
            OrderId = orderId;
            PaymentType = paymentType;

            TemplateId = SmsTemplate.OrderNotWhiteTuzPaymentId;
