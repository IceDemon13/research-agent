...
{
    public class NovaPayNovakLegalEntityPrepaymentSmsTemplate : IBusinessOperationSmsTemplate
    {
        public NovaPayNovakLegalEntityPrepaymentSmsTemplate(
            int orderPaymentId,
            int orderId,
            int orderStateId,
            SmsTemplate template)
        {
            ...
            TemplateId = SmsTemplate.NovaPayOrderPrepaymentNovakLegalEntityId;
