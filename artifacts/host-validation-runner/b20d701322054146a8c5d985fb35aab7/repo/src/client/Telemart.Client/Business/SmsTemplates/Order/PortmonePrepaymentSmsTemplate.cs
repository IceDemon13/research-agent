...
{
    public sealed class PortmonePrepaymentSmsTemplate : ISmsTemplate
    {
        public PortmonePrepaymentSmsTemplate(int orderPaymentId, int orderId, int orderStateId, SmsTemplate template)
        {
            OrderId = orderId;
            DisplayName = template.Name;

            TemplateId = SmsTemplate.PortmoneOrderPrepaymentId;
