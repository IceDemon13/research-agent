...
{
    public sealed class AssembledComputerRuleUpdateDto
    {
        [JsonProperty("name")]
        ...
        public List<AssembledComputerRuleCategoryUpdateDto> Categories { get; set; }

        [JsonProperty("products")]
        public List<AssembledComputerRuleProductUpdateDto> Products { get; set; }
    }
}