...
{
    public sealed class MonoPayPrepaymentSmsTemplate : ISmsTemplate
    {
        public MonoPayPrepaymentSmsTemplate(int orderPaymentId, int orderId, int orderStateId, SmsTemplate template)
        {
            OrderId = orderId;
            DisplayName = template.Name;

            TemplateId = SmsTemplate.MonoPayOrderPrepaymentId;
