...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the homework lesson 10 local retrieval index.")
...
def ensure_dependencies() -> None:
    ...
    if not settings.openai_api_key:
        raise ValueError("OPENAI_API_KEY is required to build embeddings for homework-lesson-10 ingestion.")
